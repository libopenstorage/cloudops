...
func (a *azureOps) SupportOnlineResize(diskName string, newSizeGB int32) string {
	...
	// disk type can't be Ultra disks or Premium SSD v2: this type is not available in the sdk version we use
