...
// CleanupPaths mocks base method.
func (m *MockOps) CleanupPaths(arg0 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CleanupPaths", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// CleanupPaths indicates an expected call of CleanupPaths.
func (mr *MockOpsMockRecorder) CleanupPaths(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CleanupPaths", reflect.TypeOf((*MockOps)(nil).CleanupPaths), arg0)
}
...
func (m *MockOps) DevicePath(arg0, arg1 string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DevicePath", arg0, arg1)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockOpsMockRecorder) DevicePath(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DevicePath", reflect.TypeOf((*MockOps)(nil).DevicePath), arg0, arg1)
}
